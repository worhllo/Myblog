> [!NOTE]
> 本项目是在原项目 [https://github.com/x-dr/short](https://github.com/x-dr/short) 的基础上进行优化和功能增强的版本。
源仓库：[wangwangitshort 基于CloudFlare的短链服务](https://github.com/wangwangit/short)
